...
async function search(key){
    ...
    async function deleteOperation(id)
    {
        if (window.confirm("Are you sure you want to delete product with id=" + id + " ?")) {
            ...
            console.warn(result);
            search();
            alert("Product has been delected");
        } else {
            search();
        }       
    }
    ...
    return(
        <div>
            ...
            <br />
            <input onChange={(e)=>search(e.target.value)} type="text" className="form-control" placeholder="Type here to search for a product"></input>
            <br />
